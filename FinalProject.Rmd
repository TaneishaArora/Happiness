...
#<strong> Somerville Happiness Dataset

### A. Brief Overview/Background of Data </strong>
<p> Add description of features </p>


###<strong> B. Analysis </strong>
...
##### 1. 5-Fold CV error rate for Reduced Model
```{r}
